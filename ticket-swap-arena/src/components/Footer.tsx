        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">TicketSwap</span>
            </Link>
            <p className="text-gray-400 mb-4">
              The safest way to buy and sell tickets for concerts, festivals, and more.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-4">Using TicketSwap</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/sell" className="text-gray-400 hover:text-white transition-colors">Sell Tickets</Link></li>
              <li><Link to="/pricing" className="text-gray-400 hover:text-white transition-colors">Pricing & Fees</Link></li>
            </ul>
          </div>
